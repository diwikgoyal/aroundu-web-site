        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Icon(Icons.location_on_outlined, color: DesignColors.accent),
                SizedBox(width: 8),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (lobbyData.priceDetails?.price != 0.0
                                      ...
                                      children: [
                                        ...
                                        AnimatedContainer(
                                          ...
                                          child: AnimatedDefaultTextStyle(
                                            ...
                                            child: DesignText(
                                              text:
                                                  '₹${totalPrice - calculateDiscount(pricingData: pricingState.pricingData, selectedOffer: selectedOffer)}',
